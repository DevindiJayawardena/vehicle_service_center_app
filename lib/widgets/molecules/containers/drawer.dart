...
class _DrawerWidgetState extends State<DrawerWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    const String toLaunch_youtube = 'https://www.youtube.com/watch?v=dds2X3a9Iv4';
            ...
            children: <Widget>[
              ...
              SingleChildScrollView(
                child: Column(
                  children: [
                    ListTile(
                      leading: Icon(Icons.home_outlined, color: Constants.appColorAmberDark,),
                    ...
                    ListTile(
                      leading: Icon(Icons.settings_outlined, color: Constants.appColorAmberDark,),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const UpdatePersonalInfoScreen()),
                        );
                      },
                    ),
                    ...
                    ListTile(
                      leading: Icon(Icons.car_repair_outlined, color: Constants.appColorAmberDark,),
                      title: const Text('Vehicle Info', style: TextStyle(
                        color: Constants.appColorBlack,
                        fontWeight: FontWeight.w600,
                      ),),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const ViewVehiclesScreen()),
                        );
                      },
                    ),
                    ...
                    ListTile(
                      leading: Icon(Icons.chat_outlined, color: Constants.appColorAmberDark,),
                      title: const Text('Ask from Bot', style: TextStyle(
                        color: Constants.appColorBlack,
                        fontWeight: FontWeight.w600,
                      ),
                      ),
                    ...
                    ListTile(
                      leading: Icon(Icons.color_lens_outlined, color: Constants.appColorAmberDark,),
                      title:  Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text('Appearance : Dark', style: TextStyle(
                            color: Constants.appColorBlack,
                            fontWeight: FontWeight.w600,
                          ),),
                    ...
                    ListTile(
                      leading: Icon(Icons.language_outlined, color: Constants.appColorAmberDark,),
                      title: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text(
                    ...
                    ListTile(
                      leading: Icon(Icons.summarize_outlined, color: Constants.appColorAmberDark,),
                      title: const Text('My Bills', style: TextStyle(
                        color: Constants.appColorBlack,
                        fontWeight: FontWeight.w600,
                      ),),
                      onTap: () {
                    ...
                    ListTile(
                      leading: Icon(Icons.phone, color: Constants.appColorAmberDark,),
                    ...
                    ListTile(
                      leading: Icon(Icons.privacy_tip_outlined, color: Constants.appColorAmberDark,),
